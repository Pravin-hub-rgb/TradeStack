...
const ToastNotification: React.FC<ToastNotificationProps> = ({
    ...
    switch (type) {
      case "success":
        return {
          ...
          icon: <CheckCircleIcon sx={{ fontSize: 24, mr: 1, color: "#60a5fa" }} />,
        };
      case "error":
        return {
          ...
          icon: <ErrorIcon sx={{ fontSize: 24, mr: 1, color: "#f87171" }} />,
        };
      case "warning":
        return {
          ...
          icon: <WarningIcon sx={{ fontSize: 24, mr: 1, color: "#fbbf24" }} />,
        };
      default:
        return {
  ...
  return (
    <Box sx={{ position: "relative", zIndex: 9999, minWidth: 300, maxWidth: 400 }}>
      <Card
